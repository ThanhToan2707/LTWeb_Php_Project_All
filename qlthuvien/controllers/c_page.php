...
if (isset($_GET['act'])) {
    ...
    switch ($_GET['act']) {
        case 'home':
            ...
            // Lấy tất cả chủ đề để hiển thị trong header
            $categories = subject_getAll();
            ...
            // Nếu có filter theo chủ đề
            $categoryBooks = null;
            $selectedCategory = null;
            if (isset($_GET['category']) && is_numeric($_GET['category'])) {
                $MaCD = $_GET['category'];
                $categoryBooks = book_getByCategory($MaCD);
                $selectedCategory = subject_getById($MaCD);
            }
