...
<?php if (count($cart) > 0): ?>
    ...
    <script>
        ...
        // Ẩn lỗi khi người dùng thay đổi ngày
        document.querySelector('#NgayTra').addEventListener('change', () => {
